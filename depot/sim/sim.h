...
public:
    ...
    void SetLambdaMan(LambdaMan* lman) {
        lman_ = lman;
    }
...
private:
    ...
    void Eat(const pair<int, int>& rc) {
        maze_[rc.first][rc.second] = ' ';
    }
    ...
    //       Fruit and Lambda-Man symbols indicate their locations but not their states.
    Maze maze_;
