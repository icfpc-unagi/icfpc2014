...
int evalAround(int x, int y, int skip) {
	int ret = 0;
	int D = 10;
	int i, j, c, d, k, t, i2, j2, d2, nearestPowerPill = INF, numSpace = 0, death = 0, takePowerPill = 0, live;
	P tmp;
