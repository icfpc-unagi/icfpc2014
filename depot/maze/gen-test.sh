...
${GEN} -width=80 -height=20 -ghosts=8  -powerpills=6  -maker=digger > depot/maze/rect-80x20.txt
${GEN} -width=80 -height=20 -ghosts=10  -powerpills=7  -maker=digger > depot/maze/rect-160x20.txt
${GEN} -width=20 -height=40 -ghosts=5  -powerpills=3  -maker=digger > depot/maze/rect-20x40.txt
${GEN} -width=20 -height=80 -ghosts=8  -powerpills=6  -maker=digger > depot/maze/rect-20x80.txt
${GEN} -width=20 -height=80 -ghosts=10  -powerpills=7  -maker=digger > depot/maze/rect-20x160.txt
